...
if (catalogo === null) {
        catalogo = [
            ...
            { id: 7, codigo: "BAR000007", nombre: "Super Mario 64", precio: 25000, stock: 10, stockCritico: 3, img: "../img/MARIO64.webp", img2: "../img/pendiente2.jpg", categoria: "Juegos", desc:"Clásico juego de plataformas 3D que definió una era. Explora el castillo de la Princesa Peach y recupera las estrellas de poder."},
            { id: 8, codigo: "BAR000008", nombre: "Mando DualShock 2", precio: 15000, stock: 15, stockCritico: 5, img: "../img/dualshock2.avif", img2: "../img/pendiente2.jpg", categoria: "Accesorios", desc:"Control original para PlayStation 2, color negro. Precisión y comodidad con vibración integrada para una mejor experiencia."},
            { id: 9, codigo: "BAR000009", nombre: "Sega Dreamcast", precio: 75000, stock: 3, stockCritico: 1, img: "../img/DREAMCAST.webp", img2: "../img/pendiente2.jpg", categoria: "Consolas", desc:"La última consola de Sega. Pionera en el juego en línea y con un catálogo lleno de innovadoras joyas arcade."},
            { id: 10, codigo: "BAR000010", nombre: "Tira de Luces RGB 5m", precio: 12000, stock: 20, stockCritico: 5, img: "../img/lucesledrgb.webp", img2: "../img/pendiente2.jpg", categoria: "Accesorios", desc:"Ilumina tu setup gamer con esta tira LED RGB de 5 metros. Control remoto incluido con múltiples modos de iluminación para darle estilo a tu pieza."},
            { id: 11, codigo: "BAR000011", nombre: "Halo: Combat Evolved", precio: 20000, stock: 7, stockCritico: 2, img: "../img/haloCE.webp", img2: "../img/pendiente2.jpg", categoria: "Juegos", desc:"El revolucionario shooter en primera persona que lanzó al estrellato a la primera consola Xbox. Únete al Jefe Maestro en su épica lucha."},
            { id: 12, codigo: "BAR000012", nombre: "Memory Card PS2 8MB", precio: 8000, stock: 12, stockCritico: 4, img: "../img/MEMORYCARD.jpg", img2: "../img/pendiente2.jpg", categoria: "Accesorios", desc:"Tarjeta de memoria oficial de 8MB para PlayStation 2. Guarda todas tus partidas y no pierdas tu progreso en tus juegos favoritos."}
        ];
